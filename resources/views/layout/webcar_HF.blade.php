...
<head>
    ...
    <!-- title of site -->
    <title>FlexiCar Rentals</title>

    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="{{ url('/Website/assets/logo/favicon.png') }}" />

    <!--font-awesome.min.css-->
    <link rel="stylesheet" href="{{ url('/Website/assets/css/font-awesome.min.css') }}">

    <!--linear icon css-->
    <link rel="stylesheet" href="{{ url('/Website/assets/css/linearicons.css') }}">

    <!--flaticon.css-->
    <link rel="stylesheet" href="{{ url('/Website/assets/css/flaticon.css') }}">
    ...
    <link rel="stylesheet" href="{{ url('/Website/assets/css/owl.theme.default.min.css') }}">

    <!--bootstrap.min.css-->
    <link rel="stylesheet" href="{{ url('/Website/assets/css/bootstrap.min.css') }}">

    <!-- bootsnav -->
    <link rel="stylesheet" href="{{ url('/Website/assets/css/bootsnav.css') }}">
...
<body>
                ...
                <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html">FlexiCar Rentals<span></span></a>
                        ...
                        <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                            <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                                ...
                                @if (session()->has('email'))
                                    @if ($user)
                                        <li ><a
                                                href="{{ url('/Profileedit') }}/{{ $user->id * 548548 }}">{{ $user->name }}</a>
                                        </li>
                                    @endif
                                @else
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                <a href="index.html">FlexiCar Rentals</a>
                            </div>
                            <p>
    ...
    <!-- bootsnav js -->
    <script src="{{ url('/Website/assets/js/bootsnav.js') }}"></script>
